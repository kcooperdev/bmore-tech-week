...
const AboutPage: React.FC<AboutPageProps> = ({ onNavigate }) => {
  return (
    <div id="about-full" className="min-h-screen bg-black pt-32 pb-24 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-24 relative">
        ...
        <div className="max-w-4xl relative z-10">
          <div className="flex items-center space-x-2 mb-6">
            ...
            <span className="font-mono text-xs tracking-[0.4em] text-[#0050FF] uppercase font-bold">EST. 2026 // CHARM CITY</span>
          </div>
      ...
      <div className="w-full relative h-[500px] md:h-[800px] overflow-hidden mb-24 border-y border-white/10">
        ...
        <div className="absolute bottom-20 left-6 md:left-24 max-w-xl z-10">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <p className="font-mono text-xs tracking-[0.5em] text-white uppercase font-bold">39.2904° N, 76.6122° W</p>
          </div>
          <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-6">
            THIS IS <br /><span className="text-[#0050FF]">OUR CITY.</span>
          </h2>
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 mb-32 items-center">
        <div>
          <h3 className="text-3xl md:text-5xl font-extrabold uppercase tracking-tight mb-8 leading-none">
            A MOVEMENT, <br /><span className="text-[#FFB400]">NOT A MEETING.</span>
          </h3>
          <div className="space-y-6 text-white/70 leading-relaxed text-lg font-light">
            <p>
              We believe the best tech scenes aren't bought—they're built. By us.
            </p>
            <p>
              This is a grassroot celebration of the <span className="text-white font-bold">engineers, hackers, and founders</span> who make Baltimore tick. No corporate agendas. No gatekeepers. Just an open platform for the community to connect, collaborate, and showcase the raw talent that defines our city.
            </p>
            <p className="bg-white/5 border-l-4 border-[#0050FF] p-6 text-white text-base md:text-lg italic">
              "This isn't just about tech; it's about the grit, the soul, and the charm that makes Baltimore a global powerhouse for innovation."
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-8 border border-white/5 bg-white/[0.02] hover:border-[#FFB400]/40 transition-all group">
            <div className="text-[#FFB400] text-3xl font-mono font-black mb-6 group-hover:scale-110 transition-transform">&gt;_</div>
            <h4 className="font-mono text-base font-bold uppercase mb-4 tracking-widest">Open Spirit</h4>
            <p className="text-white/40 text-sm">No walls. No VIP lists. We're tearing down silos to connect the city's brightest minds directly to one another.</p>
          </div>
          <div className="p-8 border border-white/5 bg-white/[0.02] hover:border-[#0050FF]/40 transition-all group">
            <Rocket className="text-[#0050FF] mb-6 group-hover:scale-110 transition-transform" size={32} />
            <h4 className="font-mono text-base font-bold uppercase mb-4 tracking-widest">High Energy</h4>
            <p className="text-white/40 text-sm">We're not just networking; we're building. This week is a catalyst for the city's future.</p>
          </div>
          <div className="p-8 border border-white/5 bg-white/[0.02] hover:border-[#FFB400]/40 transition-all group sm:col-span-2">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h4 className="font-mono text-base font-bold uppercase tracking-widest">Built with Grit</h4>
            </div>
            <p className="text-white/40 text-sm">Baltimore has a specific kind of hustle. We celebrate the unique culture that makes this city's tech scene unlike any other.</p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-[#FFB400] py-32 transform skew-y-1">
          <div className="transform -skew-y-1 max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="max-w-2xl mx-auto text-black font-bold text-xl md:text-2xl leading-tight">
              We're building a tech ecosystem that looks like Baltimore—bold, diverse, and unapologetically visionary.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 text-center relative">
        ...
        <p className="font-mono text-sm tracking-[0.5em] text-white/40 uppercase mb-8 relative z-10">THE MOVEMENT STARTS HERE</p>
        ...
        <div className="mt-24 flex flex-wrap justify-center gap-12 opacity-30 grayscale">
          <div className="font-mono text-[10px] uppercase tracking-widest">#BmoreTech</div>
          <div className="font-mono text-[10px] uppercase tracking-widest">#CharmCityBuilt</div>
          <div className="font-mono text-[10px] uppercase tracking-widest">#InnovationForAll</div>
        </div>
      </div>
    </div>
  );
